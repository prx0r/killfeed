...
Vector similarity answers "is this text semantically related?" It does not answer whether a source is primary, economically validated, newly enabled, replicable, or redundant. Stockify models those attributes explicitly.
