...
The public Firebase API is used only as an early-launch source. Stockify filters toward Show HN / API / MCP / agent / marketplace / commerce primitives and gives HN lower evidence weight than proprietary/primary data.
